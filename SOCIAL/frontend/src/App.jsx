...
// YouTube Route Wrapper - handles OAuth success/error and normal visits
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <p style={{ color: '#666', marginBottom: '20px' }}>
              Something went wrong with the social media automation platform.
            </p>
            <details style={{ 
              textAlign: 'left', 
              marginBottom: '20px', 
...
// Conditional Navbar - Only shows on protected routes, not on landing/login/register
            ...
            <main>
              <Suspense fallback={<LoadingSpinner />}>
                <Routes>
                  ...
                  {/* Protected Platform Routes - With Navbar */}
                  <Route 
                    path="/reddit-auto" 
                    element={
                      <ProtectedRoute>
                  ...
                  {/* YouTube Route with special handling for OAuth */}
