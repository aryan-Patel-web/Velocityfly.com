...
//     alert('Google signup will be implemented with your backend OAuth');
//   };

//   const handleGithubLogin = () => {
//     // Add your GitHub OAuth logic here
//     alert('GitHub signup will be implemented with your backend OAuth');
//   };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        'https://velocitypost-984x.onrender.com/api/auth/register',
        {
          name: formData.name,
